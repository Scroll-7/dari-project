...
const FEATURED_PROPERTIES = [
  { id: '1', title: 'Skyline Studio', price: '$1,200', location: 'Downtown', image: 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&q=80&w=400' },
  { id: '2', title: 'Cozy Villa', price: '$2,500', location: 'Suburbs', image: 'https://images.unsplash.com/photo-1502672260266-1c1e52d1590c?auto=format&fit=crop&q=80&w=400' },
];
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.searchContainer}>
          ...
          <TouchableOpacity style={styles.filterBtn}>
            <LinearGradient colors={[COLORS.primary, COLORS.secondary]} style={styles.filterGradient}>
            ...
            >
              <View style={styles.propertyInfo}>
                ...
                <Text style={styles.propertyLocation}>
                  <Ionicons name="location-outline" size={14} color={COLORS.white} /> {prop.location}
                </Text>
              </View>
...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: SIZES.medium, marginBottom: SIZES.xl },
  ...
  searchContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.card, borderRadius: 16, paddingHorizontal: SIZES.small, paddingVertical: 6, ...SHADOWS.light, marginBottom: SIZES.xl },
  ...
  filterGradient: { padding: 12, justifyContent: 'center', alignItems: 'center' },
  sectionHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: SIZES.medium },
  ...
  categoryIconContainer: { width: 60, height: 60, borderRadius: 30, backgroundColor: COLORS.white, justifyContent: 'center', alignItems: 'center', ...SHADOWS.light, marginBottom: SIZES.small },
  categoryText: { ...FONTS.body2, color: COLORS.text },
  propertyCard: { width: '100%', height: 200, borderRadius: 20, overflow: 'hidden', marginBottom: SIZES.medium, ...SHADOWS.medium },
  propertyImage: { width: '100%', height: '100%' },
  propertyGradient: { position: 'absolute', bottom: 0, left: 0, right: 0, height: '50%', padding: SIZES.medium, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end' },
  propertyInfo: { flex: 1 },
  propertyTitle: { ...FONTS.h3, color: COLORS.white, marginBottom: 4 },
  propertyLocation: { ...FONTS.body2, color: COLORS.white, opacity: 0.8 },
  priceTag: { backgroundColor: COLORS.primary, paddingHorizontal: 12, paddingVertical: 6, borderRadius: 12 },
