...
const CITY_PRICES = [
  { city: 'Tunis (Centre)',  avg: 1850, trend: +8.2,  color: COLORS.primary },
  { city: 'La Marsa',       avg: 2400, trend: +5.1,  color: COLORS.teal },
  { city: 'Les Berges du Lac', avg: 2200, trend: +12.4, color: COLORS.rose },
  { city: 'Sfax',           avg: 900,  trend: +3.0,  color: COLORS.gold },
  { city: 'Sousse',         avg: 1100, trend: +6.8,  color: COLORS.violet },
  { city: 'Hammamet',       avg: 1600, trend: +2.1,  color: COLORS.success },
];

const MAX_PRICE = Math.max(...CITY_PRICES.map((c) => c.avg));
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.trendsCol}>
            {CITY_PRICES.map((item) => (
              <TrendCard key={item.city} item={item} />
            ))}
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  headerTitle: { ...FONTS.h2, color: '#fff', textAlign: 'center' },
  ...
  // Section
  section: {
    paddingHorizontal: SIZES.medium, marginBottom: SIZES.large,
  },
